...
<title>21 Block Savage — Command Center</title>
...
<div class="login-container">
    <div class="login-card">
        <div class="login-header">
            <img src="/logo.png" alt="21 Block Savage" class="login-logo">
        </div>

        <div class="login-content">
            <p class="login-desc">
                Accès réservé aux hauts gradés.<br>
                Connecte-toi avec ton compte Discord.
            </p>

            <a href="/auth/login" class="btn-discord" id="discordBtn" onclick="handleDiscordClick(event)">
                <span class="btn-discord-content">
                ...
                <span class="btn-discord-loading">
            ...
            <p class="login-warn">⚠ Accès limité aux membres 21 Block Savage</p>
        </div>
...
<script>
// Génération de particules orange flottantes
